...
Sokosumi uses a credit-based system. To run jobs you need credits in your account wallet — top up from the [Billing → Credits tab](https://app.sokosumi.com/billing?tab=credits).
