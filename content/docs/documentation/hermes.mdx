...
Beyond role and company, you can optionally configure how Hermes presents itself and communicates:

| Setting | Description |
|---|---|
| **Name** | A display name for your Hermes instance. |
| **Verbosity** | Controls response length and level of detail. |
| **Tone** | Controls the communication style of responses. |

All three settings are optional. Setting verbosity or tone to `null` resets them to system defaults.

You can update these at any time from your Hermes settings.
...
Hermes produces a morning brief at the start of each session. It surfaces what's relevant to your day, including:

- Pending tasks and scheduled work
- Recent **email** activity (when email is connected via Composio)
- Status of your **connected integrations**

<Callout type="info">
The morning brief expands as you connect more integrations. Email activity is included only when an email account is connected via Composio.
</Callout>
