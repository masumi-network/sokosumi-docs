...
When you first use Hermes in Sokosumi, a new instance is provisioned for your account on a dedicated [Fly Machine](https://fly.io/docs/machines/). That instance is yours alone — no other users share it.
...
- **One Fly Machine per user** — instances are never shared.
